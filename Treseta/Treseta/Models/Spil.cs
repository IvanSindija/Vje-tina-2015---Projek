...
namespace Treseta.Models
{
    class Spil //mac grofe jedan
    {
        ...
        public Spil()
        {
            ...
            spil.Add(new Karta("kraljBastoni", Zvanje.bastoni, 7, 0, "Images/kralj_bastoni.jpg"));
            spil.Add(new Karta("kavalBastoni", Zvanje.bastoni, 6, 0, "Images/kaval_bastoni.jpg"));
            spil.Add(new Karta("fanatBastoni", Zvanje.bastoni, 5, 0, "Images/fanat_bastoni.jpg"));
            ...
            spil.Add(new Karta("kraljSpade", Zvanje.spade, 7, 0, "Images/kralj_spada.jpg"));
            spil.Add(new Karta("kavalSpade", Zvanje.spade, 6, 0, "Images/kaval_spada.jpg"));
            spil.Add(new Karta("fanatSpade", Zvanje.spade, 5, 0, "Images/fanat_spada.jpg"));
            ...
            spil.Add(new Karta("kraljKopi", Zvanje.kupe, 7, 0, "Images/kralj_kope.jpg"));
            spil.Add(new Karta("kavalKopi", Zvanje.kupe, 6, 0, "Images/kaval_kope.jpg"));
            spil.Add(new Karta("fanatKopi", Zvanje.kupe, 5, 0, "Images/fanat_kope.jpg"));
            ...
            spil.Add(new Karta("kraljDinari", Zvanje.dinari, 7, 0, "Images/kralj_dinari.jpg"));
            spil.Add(new Karta("kavalDinari", Zvanje.dinari, 6, 0, "Images/kaval_dinari.jpg"));
            spil.Add(new Karta("fanatDinari", Zvanje.dinari, 5, 0, "Images/fanat_dinari.jpg"));
